...
$\theta_2 :=\theta_1-\frac{\eta}{\sigma_1}g^1 \quad \sigma_1=\sqrt{\alpha\sigma^0+(1-\alpha)g_1^2}+\epsilon$
$\theta_3 :=\theta_2-\frac{\eta}{\sigma_2}g^0 \quad  \sigma_2=\sqrt{\alpha\sigma^1+(1-\alpha)g_2^2}+\epsilon$
### 3. Momentum
### 4. Adam
